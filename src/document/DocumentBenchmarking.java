				...
				numToCheck += increment)
		{
			 ...
			 */
			 ...
			 for(int i = 0; i < trials; i++) {
				 ...
				 double scoreBD = bd.getFleschScore();
				 long endTimeBD = System.nanoTime();
				 double estTimeBD = (endTimeBD - startTimeBD) / 100000000.0;
				 System.out.print(estTimeBD + "\t");
				 
				 long startTimeED = System.nanoTime();
				 EfficientDocument ed = new EfficientDocument(str);
				 double scoreED = ed.getFleschScore();
				 long endTimeED = System.nanoTime();
				 double estTimeED = (endTimeED - startTimeED) / 100000000.0;
				 System.out.print(estTimeED + "\n");
			 }
		}
