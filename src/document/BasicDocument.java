...
public class BasicDocument extends Document 
{
	...
	public static void main(String[] args)
	{
		 ...
		 */
		/* my code to test countSyllables method 
		 BasicDocument s = new BasicDocument("a");
		String word = "toga";
		System.out.println(word + " syllable count: " + s.countSyllables(word));
		*/
